  ...
  return (
    ...
    >
      <div className="text-center text-white px-4">
        <p className="text-xs font-semibold tracking-[0.4em] uppercase text-white/60 mb-5 [text-shadow:0_1px_12px_rgba(0,0,0,0.8)]">
          Purdue University · 2026
        </p>
        <h1 className="text-8xl md:text-[10rem] font-bold tracking-tight leading-none mb-6 [text-shadow:0_2px_40px_rgba(0,0,0,0.7)]">
          HelloWorld
        </h1>
