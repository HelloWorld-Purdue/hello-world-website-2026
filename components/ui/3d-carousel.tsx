        ...
        {cards.map((imgUrl, i) => (
          ...
          >
            <motion.img
              ...
              alt={imgUrl}
              layoutId={`img-${imgUrl}`}
              className="pointer-events-none w-full rounded-xl object-contain aspect-square p-3 brightness-0 invert opacity-80"
        ...
        {activeImg && (
          ...
          >
            <motion.img
              ...
              src={activeImg}
              className="max-w-[200px] max-h-[200px] rounded-lg brightness-0 invert"
              initial={{ scale: 0.5 }}
              animate={{ scale: 1 }}
